...
let md5 = require('md5');
let CurrenciesRepo = class CurrenciesRepo {
    constructor(mongodb) {
    ...
    async currenciesBySymbols(body) {
        return new Promise(async (resolve) => {
